...
[![Live Demo](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Live%20Demo-yellow)](https://huggingface.co/spaces/yashikaSharma/txgnn-star)
...
👉 **[Try TXGNN-StaR on Hugging Face Spaces](https://huggingface.co/spaces/yashikaSharma/txgnn-star)**

Enter any molecule as a SMILES string and get toxicity predictions across 12 Tox21 endpoints with reliability scores (ERI) and RGRT decision tiers.
...
├── best_gat_model.pt             # Trained GAT checkpoint
